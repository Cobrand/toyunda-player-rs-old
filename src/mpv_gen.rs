...
pub type mpv_event_script_input_dispatch =
    Struct_mpv_event_script_input_dispatch;
#[repr(C)]
#[derive(Copy)]
...
#[derive(Clone, Copy)]
#[repr(u32)]
pub enum Enum_mpv_sub_api { MPV_SUB_API_OPENGL_CB = 1, Pote}
...
extern "C" {
    ...
    pub fn mpv_command_string(ctx: *mut mpv_handle,
     ...
     -> ::std::os::raw::c_int;
    pub fn mpv_command_async(ctx: *mut mpv_handle, reply_userdata: uint64_t,
                             args: *mut *const ::std::os::raw::c_char)
     -> ::std::os::raw::c_int;
